...
gameOver.prototype = {
    ...
    create: function () {
        ...
        this.obj.player.player = game.add.sprite(old.position.x, old.position.y, 'player');
        ...
        this.obj.player.player.animations.add('death', [36, 37], 5, true);
        this.obj.player.player.animations.play('death');
