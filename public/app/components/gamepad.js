class Gamepad {
    ...
    _createButtons() {
        // Esquerda
        this.buttons.left = this.game.add.button(30, this.game.height - 100, 'btn_left', null, this, 0, 0, 1, 0);
        ...
        // Direita
        this.buttons.right = this.game.add.button(130, this.game.height - 100, 'btn_right', null, this, 0, 0, 1, 0);
        ...
        // Cima
        this.buttons.up = this.game.add.button(this.game.width - 100, this.game.height - 100, 'btn_up', null, this, 0, 0, 1, 0);
